...
export function Footer() {
  return (
    <footer className="bg-[var(--surface)] border-t-4 border-neutral-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-semibold text-neutral-900 mb-4 text-sm uppercase">Platform</h3>
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/languages" className="text-neutral-700 hover:text-neutral-900 transition-colors">
                  Languages
                </Link>
              </li>
              <li>
                <Link href="/rewards" className="text-neutral-700 hover:text-neutral-900 transition-colors">
                  Rewards
                </Link>
              </li>
              <li>
                <Link href="/dashboard" className="text-neutral-700 hover:text-neutral-900 transition-colors">
                  Dashboard
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-neutral-900/20 mt-10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-neutral-700 hover:text-neutral-900 text-sm transition-colors"
            >
              <Image 
                src="/lisklogo.png" 
                alt="Lisk" 
                ...
                className="w-4 h-4"
              />
              <span className="text-sm font-semibold text-neutral-900">Lisk</span>
            </a>
          </div>
