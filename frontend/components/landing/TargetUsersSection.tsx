...
export function TargetUsersSection() {
  return (
    <section id="target-users" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-neutral-100 rounded-3xl overflow-hidden aspect-[4/3] flex items-center justify-center">
            <GraduationCap className="w-16 h-16 text-neutral-400" />
          </div>

          <div className="bg-neutral-50 rounded-3xl p-8 flex items-center justify-center text-center">
            <div>
